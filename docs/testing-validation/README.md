...
#### Resolution: 
Have those empty wire spaces be treated as suc when the golden sample is submitted so that when a test harness is connected those wire positions are treated as not part of the test and input is 0.
