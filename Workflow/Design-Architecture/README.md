...
- Minimum 50 wires
- Stand-alone device
- Modular test pods (adaptor for multiple wire connectors)
- Display screen (shows pass/fail and fail type)
...
The main box houses the Main PCB (ESP32-S3 microcontroller, multiplexers, SD card, decoupling capacitors, channel protection, and power regulation providing a 3.3V rail) plus the push-button input and LCD output. Two adaptor modules connect through D-Sub couplers and cabling to the wire loom under test.
...
## Block Diagram
![Block diagram](https://raw.githubusercontent.com/Hberrill4/uav-harness-tester/main/Workflow/images/design-architecture-block-diagram.jpg)
